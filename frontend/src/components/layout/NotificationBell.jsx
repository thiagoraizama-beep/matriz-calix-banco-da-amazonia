                ...
                item.tipo === "erro" ? (
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <p style={{ margin: 0, fontSize: 12, color: "var(--text-primary)" }}>
                        <strong>{item.data.autor_nome}</strong> {item.data.eh_resposta ? "respondeu seu comentário" : "mencionou você"} em <strong>{item.data.creative_nome}</strong>: "{item.data.trecho}
